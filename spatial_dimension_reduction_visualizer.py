...
class SpatialDimensionReductionVisualizer:
    ...
    def create_baseplot(self):
        ...
        self.ax2.axis("off")
        self.ax2.set_title('Selection Mean Image:')
    ...
    def calc_img(self):
        self.img[:] = -1
        self.img[self.gy, self.gx] = np.mean(self.dframe.loc[:,self.dframe.columns[self.idx[self.toggle]]], axis=1)
...
if __name__ == "__main__":
    ...
    plot = SpatialDimensionReductionVisualizer(dframe, embedding, name, set_savepath(savepath))
    plot.plot()